...
import net.arikia.dev.dundee.npclib.events.EventListeners;
...
public class NpcLib extends DundeePlugin {
    ...
    public void onLoad() {
        PlayerNPC npc = NPC_MANAGER.createNpc(false);
        ...
        Dundee.EVENT_DISPATCHER.registerHandler(EventListeners.class);
    }
